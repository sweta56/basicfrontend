        ...
        return(
            ...
            <form onSubmit={onSubmit}>
                <div className=" flex justify-center form-group p-8">
                    ...
                    <input type="number"  value={verificationCode} onChange={(event)=>setVerificationCode(event.target.value)} className="form-control" placeholder="Enter verification code" required="required"/>
                </div>
